...
<div
	class:blur-xl={showRegistration.showRegistration}
	class=" z-10 flex flex-col justify-between min-h-screen"
>
	<div class="flex-grow flex flex-col items-center justify-center relative">
		...
		{#if showText}
			...
			<div
				class="text-white font-sans -skew-x-12 tracking-wide text-lg font-semibold text-opacity-80"
			>
	...
	<div class="w-full p-4 space-y-2">
		<button
			onclick={() => {
				showRegistration.showRegistration = true;
			}}
			type="button"
